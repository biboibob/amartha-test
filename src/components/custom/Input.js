  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="flex w-full relative">
        <input
          className={`${classNameInput && classNameInput} ${type === "password" && "!pr-12"} outline-none border-[.1rem] min-w-full md:min-w-[24rem] w-full transition-all duration-500 border-dark-gray-color focus:border-primary-color p-2 rounded-lg text-sm md:text-base`}
